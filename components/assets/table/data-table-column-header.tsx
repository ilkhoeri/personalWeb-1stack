...
import { LuArrowDown, LuArrowUp, LuChevronsUpDown, LuEyeOff, LuListRestart } from "react-icons/lu";
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="ghost"
            size="sm"
            className="-ml-1 h-8 data-[state=open]:bg-background focus-visible:ring-offset-0 focus-visible:ring-0"
          >
        ...
        <DropdownMenuContent align="start">
          ...
          <DropdownMenuItem onClick={() => column.clearSorting()}>
            <LuListRestart className="mr-2 h-4 w-4 text-muted-foreground/70" />
            Reset
          </DropdownMenuItem>
          <DropdownMenuSeparator />
