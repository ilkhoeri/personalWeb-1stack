...
const alertVariants = cva(
  "relative w-full rounded-lg border-[1px] border-[#555555] overflow-hidden [&>svg]:absolute [&>svg]:text-foreground [&>svg]:left-4 [&>svg]:top-4 [&>svg+div]:translate-y-[-3px] [&:has(svg)]:px-4py-4px-2",
  {
    variants: {
      variant: {
